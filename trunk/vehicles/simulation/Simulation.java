...
public class Simulation {
	...
	protected String simulationName = null, author = null; //the name of this vehicle
	protected Enviroment enviro; //the environment to use for this simulation
	protected Vector <Vehicle> vehicles; //the vehicles in this simulation 

	/***** Variables that will affect how the simulation runs *****/
	protected boolean perishable_vehicles, regenerating_elements, perishable_elements, evolution, sensor_view;
	protected int repro_method; //reproduction method to be used. 
	protected int gen_selecion; //genetic selection algorithm to use
	...
	public Simulation(String filename){
		try{
			...
			System.out.println("Openiing file: " + xmlLocation);
	...
	private void handleNode(Node node){
		...
		case Node.TEXT_NODE:
			...
			if(name.equals("Name")){
				...
				this.setPerishableVehicles((node_value.equals("true")));
			}
			else if(name.equals("regenerating_elements")){
				this.setRegeneratingElements((node_value.equals("true")));
			}
			else if(name.equals("perishable_elements")){
				this.setPerishableElements((node_value.equals("true")));
			}
			else if(name.equals("evolution")){
				this.setEvolution(node_value.equals("true"));
			}
				...
				this.setSensorView((node_value.equals("true")));
			}
