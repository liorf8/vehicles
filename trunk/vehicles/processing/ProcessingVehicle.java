...
public class ProcessingVehicle extends Vehicle implements PConstants {
     ...
     * 
     */
    public ProcessingVehicle(PApplet p, Vehicle v, float x, float y, float angle, float axle_length, int id) {
    ...
    public ProcessingVehicle(PApplet p, float x, float y, float angle, float axle_length, int r, int g, int b) { //constructor
